...
- (void) albumFlipAnimation {
    ...
    NSString *imageName;
    if (albumId == 0)
        imageName = [UserContext getIphoneIpadFile: @"cover-monster"];
    else if (albumId == 1)
        imageName = [UserContext getIphoneIpadFile: @"cover-animal"];
    else
        imageName = [UserContext getIphoneIpadFile: @"cover-princess"];
